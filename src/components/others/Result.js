            ...
            <div className="cardi">
              <div className="btns">
                <div className="buttonSection">
                  <button
                    disabled={data[arrays - 1].youtube === ""}
                    className="btn bg-white youtube call"
                    onClick={() => handleCall(data[arrays - 1].phone)}
                  >
                    <img src="call.jpg" alt="" />
                  </button>
                  <button
                    disabled={data[arrays - 1].website === ""}
                    onClick={() => handleLink(data[arrays - 1].website)}
                ...
                <div className="buttonSection">
                  <button
                    disabled={data[arrays - 1].facebook === ""}
                    className="btn btn-primary"
                    id="messanger"
                  >
                    <img
                      src="./messanger.svg"
                      onClick={() => handleMessenger(data[arrays - 1].facebook)}
                      alt="Facebook"
                    />
                  </button>
                  <button
                    disabled={data[arrays - 1].instagram === ""}
                    onClick={() => handleLink(data[arrays - 1].instagram)}
                ...
                <div className="buttonSection">
                  <button
                    ...
                    onClick={() => handleLink(data[arrays - 1].youtube)}
                  >
                    <img src="youtube.jpg" alt="" />
                  </button>
                  <button
                    className="btn btn-success whatsapp"
                    onClick={() => handleWhatsApp(data[arrays - 1].whatsapp)}
                  >
                ...
                <div className="buttonSection">
                  <button
                    ...
                    onClick={() => handleMail(data[arrays - 1].email)}
                  >
                    <img src="mail.png" alt="Email" />
                  </button>
                  <button
                    className="btn btn-secondry bg-white "
                    onClick={() => handleLink(data[arrays - 1].twitter)}
                  >
